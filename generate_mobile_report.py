...
<head>
    ...
    <style>
        ...
        * {{ margin: 0; padding: 0; box-sizing: border-box; -webkit-tap-highlight-color: transparent; }}
        ...
        .card-title {{ font-size: 16px; font-weight: 700; margin-bottom: 12px; color: var(--color-primary); display: flex; justify-content: space-between; align-items: center; }}
        ...
        .kpi-label {{ font-size: 11px; color: var(--color-text-muted); margin-bottom: 4px; font-weight: 500; text-align: left; padding: 0; }}
        .kpi-value {{ font-size: 20px; font-weight: 700; color: var(--color-primary); line-height: 1.2; margin-bottom: 2px; }}
        .kpi-sub {{ font-size: 10px; color: var(--color-text-muted); }}
        ...
        .ranking-info {{ flex: 1; }}
        .ranking-name {{ font-weight: 700; font-size: 15px; color: var(--color-text-main); }}
        .ranking-detail {{ font-size: 12px; color: var(--color-text-muted); margin-top: 2px; }}
        ...
        .accordion-header {{ padding: 16px; font-weight: 600; display: flex; justify-content: space-between; align-items: center; cursor: pointer; background: var(--color-surface); color: var(--color-text-main); }}
        .accordion-content {{ padding: 0 16px 16px; display: none; font-size: 13px; line-height: 1.5; color: var(--color-text-muted); border-top: 1px solid var(--color-divider); }}
        ...
        .segment-btn {{ flex: 1; padding: 8px; border: none; background: transparent; border-radius: 6px; font-size: 13px; font-weight: 600; color: var(--color-text-muted); cursor: pointer; transition: all 0.2s; }}
        ...
        .toggle-btn {{ padding: 6px 20px; border-radius: 18px; border: none; background: transparent; font-size: 13px; font-weight: 600; color: var(--color-text-muted); z-index: 1; position: relative; cursor: pointer; transition: color 0.2s; }}
        ...
        .chip {{ padding: 8px 16px; background: var(--color-surface); border: 1px solid var(--color-border); border-radius: 20px; font-size: 13px; font-weight: 500; color: var(--color-text-muted); white-space: nowrap; cursor: pointer; transition: all 0.2s; }}
...
<body>
    ...
    <div id="tab-expense" class="tab-content">
        ...
        <div id="view-ratio">
            ...
            <div class="card bg-warning-light" style="border: 1px solid var(--color-warning); box-shadow: none;">
                ...
                <div style="font-size: 13px; color: var(--color-text-muted);" id="expense-insight">
                    ...
                </div>
            </div>
        </div>
        ...
        <div id="view-cv" style="display: none;">
            ...
            <div class="card">
                ...
                <ul style="font-size: 13px; color: var(--color-text-muted); padding-left: 20px; line-height: 1.6;">
    ...
    <div id="tab-action" class="tab-content">
        ...
        <div style="margin-bottom: 16px; font-size: 13px; color: var(--color-text-muted); font-style: italic;" id="action-subtitle">
